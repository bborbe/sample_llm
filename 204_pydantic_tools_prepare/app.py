...
async def only_if_known_location(ctx: RunContext[int], tool_def: ToolDefinition) -> Union[ToolDefinition, None]:
    debug(tool_def)
    return tool_def


@weather_agent.tool_plain(prepare=only_if_known_location)
